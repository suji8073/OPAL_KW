...
public class root_making_3 extends root_making {
    public root_making_3() {
        ...
        this.table = "hotel";
        this.catlist = new ArrayList<>(Arrays.asList("all","B02010700", "B020101600", "B02010900", "B02010100", "B02011100", "B02010500", "B02011000", "B02010600", "B02010400"));
        this.c_one = new Button[5];
        this.category = new Integer[]{R.id.one_1, R.id.one_2, R.id.one_3, R.id.one_4, R.id.one_5,R.id.one_6,R.id.one_7,R.id.one_8,R.id.one_9,R.id.one_10};
